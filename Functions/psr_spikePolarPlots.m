function [nismAN, prefPhase, fa, pph] = psr_spikePolarPlots(szCounts)
...
%   pph - handle to phase preference histogram figure
%
...
for ni = 1:size(szCounts{1},1)
    nism = []; % initialize neuron spike matrix
